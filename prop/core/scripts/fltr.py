...
def run():
    ...
    #################                   AND STATEMENT           ###############
    # chienese = Restaurant.TypeChoices.CHINESE

    # c = Restaurant.objects.filter(restaurant_type = chienese,name__startswith = 'c')#####AND STATEMENT
    # pprint(c.exists())
    # pprint(c)
    ...
    # chienese = Restaurant.TypeChoices.CHINESE
    # maxican = Restaurant.TypeChoices.MEXICAN
    # indian = Restaurant.TypeChoices.INDIAN
    # check_type = [chienese,maxican,indian]
    # res = Restaurant.objects.filter(restaurant_type__in = check_type)
    # pprint(res)
    ...
    # res = Restaurant.objects.exclude(restaurant_type__in = [indian])
    # pprint(res)
    # pprint(connection.queries)

    # ###############         BETWEEN         ############

    # sale = Sale.objects.filter(income__lt<50)
    # pprint(sale)
    # pprint(connection.queries)
